...
open class JSObject : JSONObject {
    ...
    fun getInteger(key: String): Int? = getInteger(key, null)
     ...
     */
    fun getBool(key: String): Boolean? = getBoolean(key, null)
    ...
    @Throws(JSONException::class)
    fun putSafe(key: String, value: Any?): JSObject = super.put(key, value) as JSObject
