 ...
 */
public class PluginResult(private val json: JSObject = JSObject()) {
    public fun put(name: String, value: Boolean): PluginResult = jsonPut(name, value)

    public fun put(name: String, value: Double): PluginResult = jsonPut(name, value)

    public fun put(name: String, value: Int): PluginResult = jsonPut(name, value)

    public fun put(name: String, value: Long): PluginResult = jsonPut(name, value)

    /**
     * Format a date as an ISO string
     */
    public fun put(name: String, value: Date): PluginResult {
    ...
    public fun put(name: String, value: Any?): PluginResult = jsonPut(name, value)

    public fun put(name: String, value: PluginResult): PluginResult = jsonPut(name, value.json)
     ...
     */
    public val wrappedResult: JSObject
        get() {
            val ret = JSObject()
